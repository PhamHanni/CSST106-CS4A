# -*- coding: utf-8 -*-
"""Exer2-CSST106-Pantanoza.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_E5rJiWcBhDLWryFweVnrZUv6HsL0Twy
...
#Load Image
image = cv2.imread("/content/hanni.jpg")
...
# Load the image
image = cv2.imread('/content/hanni.jpg')  # Replace 'your_image.jpg' with the actual path to your image
gray_image = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
...
# Load two images
image1 = cv2.imread('/content/hanni.jpg', 0)
...
image1 = cv2.imread('/content/hanni.jpg', cv2.IMREAD_GRAYSCALE)
image2 = cv2.imread('/content/hanni2.jpg', cv2.IMREAD_GRAYSCALE)
...
image1 = cv2.imread('/content/hanni.jpg', cv2.IMREAD_GRAYSCALE) # Changed to include full path and grayscale flag
image2 = cv2.imread('/content/hanni2.jpg', cv2.IMREAD_GRAYSCALE) # Changed to include full path and grayscale flag
